# -*- coding: utf-8 -*-
"""提交阿米娅视频生成任务到 ComfyUI(API 直调,含音频链)"""
...
prompt = {
    ...
    "5": {"class_type": "LoadImage", "inputs": {"image": "amiya_ref.png"}},
    "6": {"class_type": "MiniMaxH3ReferenceToVideo", "inputs": {
        "clip": ["2", 0], "vae": ["3", 0], "audio_vae": ["4", 0],
        "prompt": "The rabbit-eared girl from the reference image in her tactical uniform, walking forward with a gentle smile, Rhodes Island base background, cinematic lighting, anime style, with ambient sound effects",
    ...
    "11": {"class_type": "SaveAnimatedWEBP", "inputs": {"images": ["10", 0], "filename_prefix": "h3_amiya", "fps": 24, "lossless": False, "quality": 90, "method": "default"}},
    "12": {"class_type": "VAEDecodeAudio", "inputs": {"samples": ["9", 0], "vae": ["4", 0]}},
    "13": {"class_type": "SaveAudio", "inputs": {"audio": ["12", 0], "filename_prefix": "h3_amiya_audio"}},
}
